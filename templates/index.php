...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="/">PESPA</a></h1>
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="/knn" class="btn-get-started scrollto">Stunting Check</a>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="../static/assets2/assets/img/ilustrasi2.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
 ...
 <section id="services" class="services section-bg">
    ...
    <section id="kontak">
        <div id="kontak" style="height: 587px;background: #f2f2f2; padding-top: 10px">
          ...
          <div class="md-form">
            ...
            <div>
              <article>
                <div style="display: flex;">
                  <img src="../static/assets2/assets/img/user.png" style="max-height: 60px; max-width: 60px">
                  <div id="text">
                    <h1 style="padding-left: 10px; color: rgb(15,68,149); font-size: 25px">Dokter1</h1>
                    <p style="padding-left: 10px">0812123123</p>
                  </div>
                </div>
              </article>
            </div>
            <div>
             ...
             <div>
              <article>
                <div style="display: flex;">
                  ...
                  <div id="text">
                    <h1 style="padding-left: 10px; color: rgb(15,68,149); font-size: 25px">Dokter1</h1>
                    <p style="padding-left: 10px">+62812123123</p>
                  </div>
                </div>
              </article>
            </div>
             <div>
              <article>
                <div style="display: flex;">
                  <img src="../static/assets2/assets/img/hospital.png" style="max-height: 60px; max-width: 60px">
                  <div id="text">
                    <h1 style="padding-left: 10px; color: rgb(15,68,149); font-size: 25px">puskesmas pitu</h1>
                    <p style="padding-left: 10px">pitu@gmail.com</p>
                  </div>
                </div>
              </article>
            </div>
