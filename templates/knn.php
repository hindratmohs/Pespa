...
<body>
  ...
  <header id="header" class="fixed-top" style="background: #37517e;">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="/" style="font-size: 20px;">Back</a></h1>
      ...
      <nav id="navbar" class="navbar" style="height: 30px align-items-center">
        <ul>
          <li><a class="nav-link scrollto active" href="/knn">K-nearest neighbor</a></li>
          <li><a class="nav-link scrollto" href="/rf">Random forest</a></li>
          <li><a class="nav-link scrollto" href="/nb">Naive Bayes</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="prediksi" class="d-flex align-items-center " style="height: 587px;">
    <div class="container">
      ...
      <div class="row" style="padding-top: 30px;">
        <div class="col-sm-8 col-sm-offset-2">
            <form action="{{ url_for('predictknn')}}" method="POST">
